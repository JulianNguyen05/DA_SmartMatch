...
import com.worklify.domain.candidate.repository.ExperienceRepository;
import com.worklify.infrastructure.persistence.mapper.CandidateEntityMapper;
import com.worklify.infrastructure.persistence.repository.ExperienceJpaRepository;
...
public class ExperienceRepositoryAdapter implements ExperienceRepository {
    ...
    public Experience save(Experience experience) {
        return mapper.toDomain(jpaRepository.save(mapper.toEntity(experience)));
    }
