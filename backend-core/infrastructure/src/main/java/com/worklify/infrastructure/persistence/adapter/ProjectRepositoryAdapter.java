...
import com.worklify.domain.candidate.repository.ProjectRepository;
import com.worklify.infrastructure.persistence.mapper.CandidateEntityMapper;
import com.worklify.infrastructure.persistence.repository.ProjectJpaRepository;
...
public class ProjectRepositoryAdapter implements ProjectRepository {
    ...
    @Override
    public List<Project> findByCandidateId(Long candidateId) {
