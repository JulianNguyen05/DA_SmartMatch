  ...
  const handleSaveCv = async () => {
    ...
    try {
      ...
      if (cvId) {
        ...
        alert("Lưu CV mới thành công!");
        // Chuyển hướng tới url có ID mới (dùng replace để tránh back lại trang tạo mới)
        navigate(`/candidate/cv-builder/${res.data.id}`, { replace: true });
      }
    } catch (error) {
