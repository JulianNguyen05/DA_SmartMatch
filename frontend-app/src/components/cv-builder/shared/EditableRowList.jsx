    ...
    <div className="w-full relative group/section">
      <div className="space-y-4 relative">
        {items.map((item, index) => (
          <div 
            key={index} 
            className="relative pb-4 border-b border-gray-100 last:border-0 group/item transition-all"
          >
            {/* Toolbar mini xuất hiện khi hover bằng CSS */}
            ...
            <div className="flex justify-between items-start gap-4 mb-0.5">
              ...
              <div 
                ...
                className={`text-xs font-semibold italic text-right min-w-[80px] ${editableClasses}`}
        ...
        {items.length === 0 && (
          <div className="text-sm text-gray-400 italic py-2">
            Chưa có thông tin. Bấm "Thêm mục mới" để bổ sung.
          </div>
        )}
      </div>
