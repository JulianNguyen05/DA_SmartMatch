...
const UserToolbar = ({ searchTerm, onSearchChange }) => {
  return (
      ...
      <div className="flex flex-col sm:flex-row gap-4 w-full md:w-auto flex-1">
        ...
        <div className="relative w-full sm:max-w-xs">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2.5 bg-gray-50 border border-gray-200 rounded-xl outline-none focus:border-purple-500 focus:ring-2 focus:ring-purple-100 transition-all text-sm"
          />
        </div>

        {/* Filter Dropdown */}
        <button className="flex items-center justify-between gap-2 px-4 py-2.5 bg-white border border-gray-200 rounded-xl hover:bg-gray-50 text-gray-700 text-sm font-medium w-full sm:w-auto transition-colors">
