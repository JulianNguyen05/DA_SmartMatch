...
import SuggestionModerationPage from "../pages/admin/SuggestionModerationPage";
...
export const router = createBrowserRouter([
  ...
  // --- NHÓM 4: ADMIN (Dùng AdminLayout) ---
  {
    ...
    element: <AdminLayout />,
    children: [
      // 1. Thêm dòng này: Tự động chuyển hướng /admin thành /admin/dashboard
      { index: true, element: <Navigate to="/admin/dashboard" replace /> },

      // 2. Thêm dòng này: Khai báo rõ đường dẫn dashboard
      ...
      { path: "suggestions", element: <SuggestionModerationPage /> },
